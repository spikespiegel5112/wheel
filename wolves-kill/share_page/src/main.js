...
import {ConfirmPlugin, LoadingPlugin, Popup, Tab, TabItem, XInput, Group, Cell, CellBox, XAddress, Selector,Picker, PopupPicker, Toast, WechatPlugin } from 'vux'
...
Vue.prototype.$domainUrl = process.env.NODE_ENV === 'production' ? 'http://activity.fnvalley.com/wolves_kill/index.html' : 'http://activity.fnvalley.com/testwolves_kill/index.html';
Vue.prototype.$shareDomainUrl = process.env.NODE_ENV === 'production' ? 'http://activity.fnvalley.com/wolves_kill/canvass/index.html' : 'http://activity.fnvalley.com/testwolves_kill/canvass/index.html';
